...
from local_chat.constants import PROJECT_ROOT_PATH
from local_chat.di import global_injector
from local_chat.open_ai.extensions.context_filter import ContextFilter
from local_chat.server.chat.chat_service import ChatService, CompletionGen
from local_chat.server.chunks.chunks_service import Chunk, ChunksService
from local_chat.server.ingest.ingest_service import IngestService
from local_chat.server.recipes.summarize.summarize_service import SummarizeService
from local_chat.settings.settings import settings
from local_chat.ui.images import logo_svg

logger = logging.getLogger(__name__)

THIS_DIRECTORY_RELATIVE = Path(__file__).parent.relative_to(PROJECT_ROOT_PATH)
# Should be "local_chat/ui/avatar-bot.ico"
AVATAR_BOT = THIS_DIRECTORY_RELATIVE / "fevicon.png"

UI_TAB_TITLE = "My Local ChatBot"
    ...
    def _build_ui_blocks(self) -> gr.Blocks:
        ...
        with gr.Blocks(
            ...
            with gr.Row():
                ...
                gr.HTML(
                    f"<div class='footer'><a class='footer-skillpedia-link' href='https://skillpedia.ai/'>Maintained by SkillPedia <img class='footer-skillpedia-ico' src='{f_base64}' alt=SkillPedia></a></div>"
                )
