...
from local_chat.components.llm.prompt_helper import get_prompt_style
from local_chat.paths import models_cache_path, models_path
...
class LLMComponent:
    ...
    def __init__(self, settings: Settings) -> None:
        ...
        if settings.llm.tokenizer and settings.llm.mode != "mock":
            ...
            try:
                ...
                logger.warning(
                    ...
                    f"https://docs.localchat.dev/installation/getting-started/troubleshooting#tokenizer-setup."
        ...
        match settings.llm.mode:
            ...
            case "sagemaker":
                try:
                    from local_chat.components.llm.custom.sagemaker import SagemakerLLM
                except ImportError as e:
                    raise ImportError(
            ...
            case "ollama":
                ...
                if ollama_settings.autopull_models:
                    from local_chat.utils.ollama import check_connection, pull_model
