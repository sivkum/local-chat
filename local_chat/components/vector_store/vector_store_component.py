...
from local_chat.paths import local_data_path
        ...
        match settings.vectorstore.database:
            ...
            case "chroma":
                try:
                    ...
                    from local_chat.components.vector_store.batched_chroma import (
            ...
            case "milvus":
                ...
                if settings.milvus is None:
                    logger.info(
                        ...
                        "Trying to connect to Milvus at local_data/local_chat/milvus/milvus_local.db "
